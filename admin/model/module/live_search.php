<?php
namespace Opencart\Admin\Model\Extension\LiveSearch\Module;
...
class LiveSearch extends \Opencart\System\Engine\Model
{
    ...
    public function getExtensions(){
        $files = glob(DIR_OPENCART . 'extension/live_search/admin/controller/live_search/*.php');
        $extensions = array();
        if ($files) {
        ...
        if (is_file(DIR_OPENCART . 'extension/live_search_pro/install.json')) {
            $files = glob(DIR_OPENCART . 'extension/live_search_pro/admin/controller/live_search/*.php');
            if ($files) {
                foreach ($files as $file) {
                    $extensions[] = basename($file, '.php');
                }
